<?php
	print("<h2>Dice by Days of Week: Weekdays</h2><br>");
	$home = "../index.php";
	...
	function getProduct()
	{
		...
		WHERE 
			...
			AND (time.day_of_week = 'Monday' OR time.day_of_week = 'Tuesday' OR time.day_of_week = 'Wednesday' OR  time.day_of_week = 'Thursday') 
		GROUP BY 
			product.description;";
