<?php
	...
	function getTime()
	{
		...
		$query = 
		"SELECT 
			time.month, SUM(salesfact.unit_sales), ROUND(SUM(salesfact.dollar_sales), 2), ROUND(SUM(salesfact.dollar_cost), 2), SUM(salesfact.customer_count)
		FROM 
			time, salesfact 
		WHERE 
