<?php
	...
	function getProduct()
	{
		...
		$query = 
		"SELECT 
			product.department, SUM(salesfact.unit_sales), ROUND(SUM(salesfact.dollar_sales), 2), ROUND(SUM(salesfact.dollar_cost), 2), SUM(salesfact.customer_count)
		FROM 
			product, salesfact 
		WHERE 
